...
let cpuGauge = Gauge(document.getElementById('gauge-cpu'), {
    max: 100,
    label: value => {
    ...
    value: 50,
    color: val => {
        if (val > 90) return '#ad1d1d';
        return val < 70 ? '#008fff' : '#ffcc00';
    }
});


let ramGauge = Gauge(document.getElementById('gauge-ram'), {
    max: 100,
    label: value => {
...
let diskGauge = Gauge(document.getElementById('gauge-disk'), {
    max: 100,
    label: value => {
        return Math.round(value) + '%';
      },
...
let cpuGaugeLoad = Gauge(document.getElementById('gauge-cpu-load'), {
    max: 100,
    label: value => {
        return Math.round(value) + '%';
      },
...
let cpuGaugeClock = Gauge(document.getElementById('gauge-cpu-clock'), {
    max: 5,
    label: value => {
...
let cpuGaugeHeat = Gauge(document.getElementById('gauge-cpu-heat'), {
    max: 100,
    label: value => {
...
let cpuGauge0Load = Gauge(document.getElementById('gauge-cpu-0-load'), {
    max: 100,
    label: value => {
        return Math.round(value) + '%';
      },
...
let cpuGauge0Heat = Gauge(document.getElementById('gauge-cpu-0-heat'), {
    max: 100,
    label: value => {
        return Math.round(value) + '°C';
      },
